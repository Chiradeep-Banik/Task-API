...
describe('Test for POST at /users/signup', () => {
    describe('If password or name or email is not provided', () => {
        ...
        for (var body in req_obj) {
            test('Should return 400', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).post('/users/signup').send(body);
    ...
    describe('If everything is provided', () => {
        ...
        test('Should return authorization header', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).post('/users/signup').send({
                "email": "mail2@gmail.com",
                "password": "123QWEqwQe!@#",
                "name": "USER2"
