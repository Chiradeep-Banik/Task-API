...
describe('Test for DELETE at /users/me', () => {
    describe('Auth token is not provided', () => {
        test('Should return 400', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).delete('/users/me');
            expect(res.status).toBe(400);
        }));
    });
    describe('Auth token is provided', () => {
        test('Should return 400 -- for wrong token', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).delete('/users/me').set('Authorization', 'Bearer wrong_token');
            expect(res.status).toBe(400);
        }));
        describe('Everything is correct', () => {
            test('Should return 200', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).delete('/users/me').set('Authorization', `Bearer ${token}`);
                expect(res.status).toBe(200);
            }));
            test('Should delete every trace of the user', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).delete('/users/me').set('Authorization', `Bearer ${token}`);
                var user_res = yield user_model_1.user.findById(id.toString());
                expect(user_res).toBe(null);
            }));
            test('Should delete the all the tasks of the user', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).delete('/users/me').set('Authorization', `Bearer ${token}`);
                var tasks_res = yield task_model_1.task.find({ creator_id: id.toString() });
