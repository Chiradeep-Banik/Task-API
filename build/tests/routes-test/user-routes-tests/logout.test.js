...
describe('Test for POST at /users/me/logout', () => {
    describe('Auth token is not provided', () => {
        test('Should return 400', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logout');
            expect(res.status).toBe(400);
        }));
    });
    describe('Auth token is provided', () => {
        test('Should return 400 -- for wrong token', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logout').set('Authorization', 'Bearer wrong_token');
            expect(res.status).toBe(400);
        }));
        describe('Everything is correct', () => {
            test('Should return 200', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logout').set('Authorization', `Bearer ${token}`);
...
describe('Test for POST at /users/me/logoutall', () => {
    describe('Auth token is not provided', () => {
        test('Should return 400', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logoutall');
            expect(res.status).toBe(400);
        }));
    });
    describe('Auth token is provided', () => {
        test('Should return 400 -- for wrong token', () => __awaiter(void 0, void 0, void 0, function* () {
            var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logoutall').set('Authorization', 'Bearer wrong_token');
            expect(res.status).toBe(400);
        }));
        describe('Everything is correct', () => {
            test('Should return 200', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logoutall').set('Authorization', `Bearer ${token}`);
                expect(res.status).toBe(200);
            }));
            test('Should have only public fields', () => __awaiter(void 0, void 0, void 0, function* () {
                var res = yield (0, supertest_1.default)(app_1.app).post('/users/me/logoutall').set('Authorization', `Bearer ${token}`);
